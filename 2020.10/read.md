...
1.用电压表检测麦克风模块在有声音和没声音的信号线输出电平，有声音输出电压约为0，没声音为2.4v

2。计算原理图每一点的电压

3.重新画麦克风模块的电路原理图，了解了麦克风模块的工作原理。

当没有声音时，麦克风内部的弹片没有震动，电容值没有发生变化，所以麦克风的非地线没有电压变化，两个三极管处于截止状态，信号线输出为稳压二极管的稳压值2.4v。

当有声音时，声音让麦克风内部弹片震动，让电容两端距离发生变化，进而电容值发生变化。因为电荷Q恒定不变，由公式Q=CU可得，C变化，所以电压u也变化，进而在C1电容产声电压差，在三极管Q1基极产生电流，经过三极管放大，从Q1三极管的集电极流向Q2的基极，此时因为电流经过了放大，使Q2三极管处于导通状态，使信号线接地输出为0.
